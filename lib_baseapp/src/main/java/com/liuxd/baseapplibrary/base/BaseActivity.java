...
import com.liuxd.baseapplibrary.R;
import com.liuxd.baseapplibrary.utils.AppManager;
import com.liuxd.baseapplibrary.utils.LogUtil;
import com.liuxd.baseapplibrary.utils.ToastUtil;
...
public abstract class BaseActivity extends AppCompatActivity implements IBase {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStatusBarColor(getResources().getColor(R.color.colorPrimary), 0);//设置状态栏颜色
