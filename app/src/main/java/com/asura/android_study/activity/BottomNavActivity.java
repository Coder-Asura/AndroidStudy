...
import com.asura.android_study.activity.fragtofrag.Fragment1;
import com.asura.android_study.activity.fragtofrag.Fragment2;
...
//        mNav.getMenu().add(1,4,4,"呵");
        lastItem = mNav.getMenu().getItem(0);
