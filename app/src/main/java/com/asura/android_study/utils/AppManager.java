...
public class AppManager {
    ...
    public void addActivity(Activity activity) {
        ...
        for (int i = 0; i < activityList.size(); i++) {
            ALog.INSTANCE.d("activityListAdd", activityList.get(i).getClass().getSimpleName());
        }
    }
    ...
    public void removeActivity(Activity activity) {
        ...
        for (int i = 0; i < activityList.size(); i++) {
            ALog.INSTANCE.d("activityListRemove", activityList.get(i).getClass().getSimpleName());
        }
    }
    ...
    public void finishToActivity(Class activity) {
        ...
        for (int i = activityList.size() - 1; i >= 0; i--) {
            ...
            ALog.INSTANCE.d("activityList", item.getClass() + "=====" + activity);
