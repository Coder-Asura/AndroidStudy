...
public class LxdView extends View {
    private int mWidth;
    private int mHeight;
...
//    }
    ...
    public LxdView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LxdView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
