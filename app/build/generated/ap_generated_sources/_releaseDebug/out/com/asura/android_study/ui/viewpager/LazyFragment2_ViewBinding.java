...
public class LazyFragment2_ViewBinding implements Unbinder {
  private LazyFragment2 target;

  @UiThread
  public LazyFragment2_ViewBinding(LazyFragment2 target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LazyFragment2 target = this.target;
