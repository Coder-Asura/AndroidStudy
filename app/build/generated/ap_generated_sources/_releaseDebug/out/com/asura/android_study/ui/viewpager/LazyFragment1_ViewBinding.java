...
public class LazyFragment1_ViewBinding implements Unbinder {
  private LazyFragment1 target;

  @UiThread
  public LazyFragment1_ViewBinding(LazyFragment1 target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LazyFragment1 target = this.target;
