...
public class LazyFragment3_ViewBinding implements Unbinder {
  private LazyFragment3 target;

  @UiThread
  public LazyFragment3_ViewBinding(LazyFragment3 target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LazyFragment3 target = this.target;
