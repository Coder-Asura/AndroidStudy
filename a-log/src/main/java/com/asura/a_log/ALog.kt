 ...
 *
 * @author Asura Created by Asura on 2018/06/07 10:09.
 */
object ALog {
    private val TAG = "ALog"
    private val METHOD_LINE = "() : \n"
    private val SPLIT_LINE = "<---------->%s"
    private val SPLIT_LINE2 = "<---------->%s\n"
     ...
     * 这里对Logger的一些初始化设置
     */
    fun initLog(logEnable: Boolean, tag: String = TAG): Settings {
        return Logger.init(tag)//设置tag
                .logLevel(if (logEnable) LogLevel.FULL else LogLevel.NONE)//日志等级
