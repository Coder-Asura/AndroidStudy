...
/**
 * @author Created by Asura on 2018/6/12 14:47.
 */
abstract class BaseRxLifecycleFragment<V : IMvpView, P : IMvpPresenter<V>> : BaseFragment<V, P>(), LifecycleProvider<FragmentEvent> {
